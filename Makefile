##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.0.0] date: [Mon Feb 25 22:32:41 PST 2019]
##########################################################################################################################
...
flash: $(BUILD_DIR)/$(TARGET).elf
	openocd -s /usr/share/openocd/scripts/interface -s /usr/share/openocd/scripts/target -f stlink.cfg -c "adapter_khz 4000" -c "transport select hla_swd" -f stm32l0.cfg -c "program build/stm32l053_stopmode.elf verify reset exit"
# *** EOF ***
